...
public:
    ...
    virtual void ray_trace_gpu(uint32_t n_elements, const float* rays_o, const float* rays_d, float* positions, float* normals, float* depth, int32_t* face_id, const Triangle* gpu_triangles, cudaStream_t stream) = 0;
